...
class StoreCardRequest extends FormRequest
{
    ...
    {
        return [
            'visit_date.required' => 'Vui lòng nhập Ngày đến cửa hàng!',
            'visit_date.date_format' => 'Ngày đến cửa hàng không đúng định dạng (DD/MM/YYYY)!',
            'salon_id.required' => 'Vui lòng chọn Cửa hàng!',
            'is_cut.required' => 'Vui lòng chọn Có cắt tóc hay không!',
            'is_perm.required' => 'Vui lòng chọn Có uốn tóc hay không!',
            'perm_note.max' => 'Ghi chú uốn tóc không được vượt quá 200 ký tự!',
            'is_color.required' => 'Vui lòng chọn Có nhuộm tóc hay không!',
